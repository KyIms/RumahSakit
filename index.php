<?php
    session_start();
    include('app/user/assets/inc/config.php');//get configuration file
    include('app/user/assets/inc/login.php');//get configuration file
?>
<!--End Login-->
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <!-- App favicon -->
    <link rel="shortcut icon" href="app/user/assets/images/favicon.ico">

    <!-- App css -->
    <link href="app/user/assets/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
    <link href="app/user/assets/css/icons.min.css" rel="stylesheet" type="text/css" />
    <link href="app/user/assets/css/app.min.css" rel="stylesheet" type="text/css" />
    <!--Load Sweet Alert Javascript-->

    <script src="app/user/assets/js/swal.js"></script>
    <!--Inject SWAL-->
...
<body class="authentication-bg authentication-bg-pattern">
                        ...
                        <div class="card-body p-4">
                            ...
                            <form method='post'>
                                ...
                                <div class="form-group mb-0 text-center">
                                    <button class="btn btn-primary btn-block" name="user_login" type="submit">Log In
                                    </button>
                                </div>
    ...
    <!-- App js -->
    <script src="app/user/assets/js/app.min.js"></script>
