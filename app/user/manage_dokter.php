<?php
  ...
  if(isset($_GET['delete']))
  {
        ...
        $adn="delete from dokter where id_dokter=?";
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box">
                                ...
                                <h4 class="page-title">Manage Detail Dokter</h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                                    ...
                                    <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-hide="phone">Spesialis</th>
                                        ...
                                        <?php
                                            /*
                                                ...
                                                *
                                            */
                                                $ret="SELECT * FROM  dokter ORDER BY RAND() "; 
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><?php echo $row->no_dokter;?></td>
                                                <td><?php echo $row->spesialis;?></td>
                                                <td><?php echo $row->email;?></td>

                                                <td>
                                                    <a href="manage_dokter.php?delete=<?php echo $row->id_dokter;?>"
                                                        class="badge badge-danger"><i
                                                            class=" mdi mdi-trash-can-outline "></i> Hapus</a>
                                                    <a href="detail_dokter.php?id_dokter=<?php echo $row->id_dokter;?>&&id_dokter=<?php echo $row->id_dokter;?>"
                                                        class="badge badge-success"><i class="mdi mdi-eye"></i>
                                                        Lihat</a>
                                                    <a href="update_dokter.php?id_dokter=<?php echo $row->id_dokter;?>"
