...
<?php
	...
	include('assets/inc/config.php');
		if(isset($_POST['add_patient']))
		{
			...
			$query="insert into pasien (f_nama, keluhan, l_nama, umur, pat_dob, no_pasien, no_tlp, kategori, alamat) values(?,?,?,?,?,?,?,?,?)";
			$stmt = $mysqli->prepare($query);
			$rc=$stmt->bind_param('sssssssss', $f_nama, $keluhan, $l_nama, $umur, $pat_dob, $no_pasien, $no_tlp, $kategori, $alamat);
			$stmt->execute();
			/*
			...
			*/ 
			...
			if($stmt)
			{
				$success = "Detail Pasien Ditambahkan";
			}
			else {
				$err = "Harap Coba Lagi";
			}
                                    ...
                                    <form method="post">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input required="required" type="text" name="umur" class="form-control"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input required="required" type="text" class="form-control" name="alamat"
                                                id="inputAddress" placeholder="Alamat Pasien">
                                        </div>
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <input required="required" type="text" name="keluhan"
                                                    class="form-control" id="inputCity">
                                            </div>
                                            <div class="form-group col-md-4">
                                                <label for="inputState" class="col-form-label">Tindakan</label>
