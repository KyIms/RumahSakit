...
<body>
    ...
    <div id="wrapper">
        ...
        <?php
                $pay_no = $_GET['pay_no'];
                $ret="SELECT  * FROM invoice WHERE pay_no = ?";
                $stmt= $mysqli->prepare($ret) ;
                $stmt->bind_param('s',$pay_no);
                $stmt->execute() ;//ok
                $res=$stmt->get_result();
                $cnt=1;
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 offset-md-2">
                                        <div class="mt-3 float-right">
                                            <p class="m-b-10"><strong>Tanggal Cetak : </strong> <span
                                                    class="float-right"> &nbsp;&nbsp;&nbsp;&nbsp;
                                            ...
                                            <p class="m-b-10"><strong>No Invoice : </strong> <span
                                                    class="float-right"><?php echo $row->pay_no;?></span></p>
                                            ...
                                            <table class="table mt-4 table-centered table-bordered">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="text-right">Rp. <?php echo $taxable_salary;?></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="float-right">
                                            <p><b>Sub-total:</b> <span class="float-right">Rp.
                                                    <?php echo $row->pay_emp_salary;?></span></p>
                                            <p><b>PAYE Tax (10%) :</b> <span class="float-right"> &nbsp;&nbsp;&nbsp;
                                                    <?php echo $taxable_salary;?> </span></p>
                                            <h3>Rp. <?php echo $total_salary;?></h3>
                                        </div>
