<?php
  ...
  {
        $id=intval($_GET['delete_userid']);
        $adn="delete from users where userid=?";
                                ...
                                <div class="table-responsive">
                                    <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0"
                                        ...
                                        <thead>
                                            <tr>
                                                <th>#</th>
                                                <th data-toggle="true">Nama User</th>
                                                <th data-hide="phone">No User</th>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="lihat_detail_user.php?nomor=<?php echo $row->nomor;?>"
                                                    ...
                                                    <a href="update_user.php?userid=<?php echo $row->userid;?>"
                                                        ...
                                                        Update</a>
                                                    <a href="manage_user.php?delete_userid=<?php echo $row->userid?>"
